            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                <td>CORTISOL HEALTH</td>
                                <td><img src="../images/sup2.jpg" alt="" width="150" height="100"/></td>
                                <td>10</td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            <tr>
                                <td>PURE WHEY</td>
                                <td><img src="../images/sup3.png" alt="" width="150" height="100"/></td>
                                <td>5</td>
                            </tr>
                        </tbody>
                    </table>
